...
/* Easier to use defines - by Saivert */
...
#define WINAMP_BUTTON_REW5S              WINAMP_BUTTON1_SHIFT
#define WINAMP_BUTTON_OPENFILE           WINAMP_BUTTON2_SHIFT
#define WINAMP_BUTTON_STOPWITHFADEOUT    WINAMP_BUTTON4_SHIFT
#define WINAMP_BUTTON5_FF5S              WINAMP_BUTTON5_SHIFT
#define WINAMP_BUTTON_STARTOFLIST        WINAMP_BUTTON1_CTRL
#define WINAMP_BUTTON_OPENURL            WINAMP_BUTTON2_CTRL
#define WINAMP_BUTTON_STOPAFTERCURRENT   WINAMP_BUTTON4_CTRL
#define WINAMP_BUTTON_ENDOFLIST          WINAMP_BUTTON5_CTRL
// does nothing: WINAMP_BUTTON3_SHIFT
// does nothing WINAMP_BUTTON3_CTRL
